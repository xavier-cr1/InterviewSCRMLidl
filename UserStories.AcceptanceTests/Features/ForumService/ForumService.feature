...
@Type:API
#Create a new message with a specific theme. Obtain full forum messages list (addtional meaningful, check the message exists in theme list)
Scenario: Obtain a new created message in the forum inside its theme list
